...
** Предположения
1. Запускаем все на одной машине
2. security это не проблема
3. requirements.txt в корне проекта
4. Настройка всяких хабов - дело devops по уже готовому проекту
5. Все порты торчат наружу - для удобства разработки
** Решение
